...
FILE_DESCRIPTION = "Battlezone ZFS Specialist"
INTERNAL_NAME = "BZZFSSpecialist"
ORIGINAL_FILENAME = "BZZFSSpecialist.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 3.1.3 or v3.1.3")
